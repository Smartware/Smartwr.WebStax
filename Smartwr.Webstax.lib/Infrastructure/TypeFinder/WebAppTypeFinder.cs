...
namespace Smartwr.Webstax.lib.Infrastructure.TypeFinder
{
    public class WebAppTypeFinder : AppDomainTypeFinder
    {
        ...
        public WebAppTypeFinder(Boolean isDiscovery)
        {
            this._ensureBinFolderAssembliesLoaded = isDiscovery;
        }
        ...
        /// checked for being loaded on application load. This is need in situations where plugins need to be loaded
