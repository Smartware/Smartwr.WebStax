...
using Smartwr.Webstax.lib.Infrastructure.Identity;
...
namespace Smartwr.Webstax.lib.MiddleServices.Extensions
{
    ...
    public static class IdentityExtensions
    {
        ...
        public static IdentityResult ToIdentityResult(this ApplicationIdentityResult applicationIdentityResult)
        {
            return applicationIdentityResult == null ? null : new IdentityResult(applicationIdentityResult.Errors);
        }
        ...
        public static ApplicationIdentityUser CopyAppUserProperties(this ApplicationIdentityUser applicationIdentityUser, AppUser appUser)
        {
            ...
            applicationIdentityUser.City = appUser.City;
            applicationIdentityUser.State = appUser.State;
