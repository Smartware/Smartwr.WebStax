...
namespace Smartwr.Webstax.lib.MiddleServices.Interfaces.Auth
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        ApplicationIdentityResult AddClaim(int userId, Claim claim);
        ...
        Task<ApplicationIdentityResult> AddUserToRoles(int userId, IList<string> roles);
        ...
        ApplicationIdentityResult Delete(int userId);
        ...
        ApplicationIdentityResult Update(AppUser user);
